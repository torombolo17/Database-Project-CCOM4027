<?php
	...
	$query = 'select * from InvestigacionInnas natural join Investigo natural join Produjo where id_innas ='.$idinve;
	$boolofq = mysql_query($query);
	$resultofq = mysql_fetch_array($boolofq);

	$query2 = 'select nombre, user_id from Usuario natural join Estudiante natural join Investigo where id_innas='.$idinve;
			...
			<nav class="navbar navbar-default" role="navigation">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href=<?php echo "home3.php"?> >Home</a>
					</div>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							<li>
								<a href = "login.html" onclick="">Login</a>
							</li>
						</ul>
	...
	<div class="panel-body">
		...
		<ul style="list-style:none">
			...
			<li><h4 style="display: inline">Program: </h4> <?php if($resultofq['summer'] == 1){
															...
															?> </li><br />
			<li><h4 style="display: inline">Student: </h4><?php echo "<a href=publicprofile3.php?theguy=".$resultofq2['user_id'].'>'.$resultofq2['nombre'].'</a>' ?> </li><br />
		</ul>
	</div>
	</div>
	</div>
