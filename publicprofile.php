		...
		<div class="panel-body">
			...
			<?php
				if(!$flaginve){
					...
					echo "<a href= publicresearch.php?user=".$username."&inve=".$resultofq2['id_innas'].">".$resultofq2['titulo']."</a>";
					echo "<br />";
	...
	<div class="panel-body">
		...
		<?php
			if(!$flagprod){
				...
				echo "<a href= publicproduct.php?user=".$username."&prod=".$resultofq3['id_producto'].">".$resultofq3['nombre_prod']."</a>";
				echo "<br />";
