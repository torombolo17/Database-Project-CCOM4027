<?php
	...
	$query2 = 'select nombre from Usuario where user_id ="'.$username.'"';
...
<!-- fixed top nav bar -->
	...
	<div class="container" style="padding-bottom:20px">
		<ul class="nav nav-tabs offset2 span5">
			<li class="active"><a href=<?php echo "product.php?user=".$username."&prod=".$prod ?>>Product</a></li>
			<li><a href= <?php echo "editproduct.php?user=".$username."&prod=".$prod ?>>Edit Product</a></li>
			<li><a href= <?php echo "confirmdeletep.php?user=".$username."&prod=".$prod ?>>Delete Product</a></li>
		</ul>
	</div>
